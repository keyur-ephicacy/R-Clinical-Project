---
title: "R functions used commonly in SDTM programming"
subtitle: " "
author: "Keyur Patel"
institute: ""
date: "( `r Sys.Date()`)"
...
raw_vs <- data.frame(
  ...
  Visit_Date = c("2025-04-03","2025-04-04","2025-04-10","2025-04-06","2025-04-07","2025-04-12"),
...
## Transposing the data using pivot_longer and Pivot_wider
### pivot_longer
...
vs_pre <- vs_t |> mutate(DOMAIN ="VS",
                 ...
                 VISIT =if_else(VISITNUM == 0, "Screening",paste("Week",Visit_Number)),
                 
                 VSSTRESC   = as.character(VSORRES),
                 VSSTRESN   = as.numeric(VSORRES)) |> select(-Subject_ID,-Visit_Number)
```
---
...
vs_dt <- vs_pre |> mutate(VSDTC = case_when(
